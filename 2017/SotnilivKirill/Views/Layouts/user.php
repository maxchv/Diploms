        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                	...
                	<li><?php MVC\Helpers\Html::actionLink("index", "Главная", "User") ?></li>
                	<li><?php MVC\Helpers\Html::actionLink("about", "FAQ", "User") ?></li>
                	<li><?php MVC\Helpers\Html::actionLink("contact", "Контакты", "User") ?></li>
                	<li><?php MVC\Helpers\Html::actionLink("profile", "Профиль", "User") ?></li>
                	<li><?php MVC\Helpers\Html::actionLink("createarticle", "Написать статью", "User") ?></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
               		<li><?php 
						...
						<li><?php MVC\Helpers\Html::actionLink("logout", "Выход", "User") ?></li>
                </ul>
            </div>
        	</div>
   		 </div>
     ...
     <div class="row">
        ...
        <div class="col-md-4">
			    ...
			    <div class="panel panel-default">
				    ...
				    <ul class="list-group">
				    	...
				    	{	
				    		...
				    		<li class="list-group-item"><?php MVC\Helpers\Html::actionLink("article", $i.'. '.$header , "User", $someresult['Id'] , ["class" => ""])?></li>	
				    		<?php 			    		
				    	}
				    	?>
				    </ul>
			    ...
			    <ul class="list-group">
			    	...
			    	echo "<form action=\"/User/selectedcategory\" method=\"post\">";
