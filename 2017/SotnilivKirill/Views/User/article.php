...
<article>
		...
		document.write(VK.Share.button({url: 'http://mysite.com', title: 'Blog'},{type: "custom", text: "<img src=\"https://vk.com/images/share_32.png\" width=\"32\" height=\"32\" />"}));
		--></script>
		</div>
    ...
    <li class="comment">
		...
		<?php		
			if($commentRow['UserId']==$_SESSION[Id]){
				$rowId = $commentRow['Id'];
				MVC\Helpers\Html::actionLink("deletecomment", "удалить комментарий", "User", $rowId, ["class" => ""]);
			}
		?>
		</div>
		<br/>
