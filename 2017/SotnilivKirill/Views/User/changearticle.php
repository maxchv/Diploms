...
<form enctype="multipart/form-data"  class="form-horizontal" role="form" method="post" action="/Blog/User/checkarticle" >
	...
	echo "<font size=\"6\" color=\"red\">Ошибка</font><br /><b>Перейти на <a href='/Blog/User/index'>главную страницу</a></b>";
}