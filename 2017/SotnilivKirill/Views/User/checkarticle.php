...
mysqli_set_charset($mysqli, "utf8");
			...
			if (!empty($_POST['header'])&&!empty($_POST['category'])&&!empty($_POST['article'])){
				if (strlen($_POST['header'])>50){
					echo "<font size=\"5\" color=\"red\">Ошибка! Превышен лимит длины заголовка!</font><br /><b>Вернуться на страницу <a href='/User/createarticle'>оформления статьи</a></b>";
				}
				elseif(strlen($_POST['article'])>3000){
					echo "<font size=\"5\" color=\"red\">Ошибка! Превышен лимит длины статьи!</font><br /><b>Вернуться на страницу <a href='/User/createarticle'>оформления статьи</a></b>";
				}
				else{
					$header = $_POST['header'];
					...
					$stmt->execute();
					echo "<font size=\"6\" color=\"green\">Статья успешно создана!</font><br /><b>Перейти на <a href='/User/index'>главную страницу</a></b>";
				}
			}
			elseif (!empty($_POST['changeheader'])&&!empty($_POST['changecategory'])&&!empty($_POST['changearticle'])){
				...
				elseif(strlen($_POST['changearticle'])>2000){
					echo "<font size=\"5\" color=\"red\">Ошибка! Превышен лимит длины статьи!</font><br /><b>Вернуться на страницу <a href='/Blog/User/createarticle'>оформления статьи</a></b>";
				}
				else{
					...
					echo "<font size=\"6\" color=\"green\">Статья успешно обновлена!</font><br /><b>Перейти на <a href='/User/index'>главную страницу</a></b>";
				}
					
			}
			else{
				echo "<font size=\"6\" color=\"red\">Ошибка! Не все поля заполнены!</font><br /><b>Вернуться на страницу <a href='/User/createarticle'>оформления статьи</a></b>";
			}
