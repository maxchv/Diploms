    ...
    <article>
        ...
        <div class="row">
            ...
            <div class="group2 col-sm-6 col-md-6">
                ...
                <div class="pull-right"><?php echo "&nbsp;" . $row["Datetime"] ?></div>
...
if ($page >= 1) {
    ...
    // поэтому так и пишем
    MVC\Helpers\Html::actionLink("selectedcategory", "<font size=\"5\"><< </font>", "Home", 1, ["class" => ""]);
    ...
    MVC\Helpers\Html::actionLink("selectedcategory", "<font size=\"5\"><</font>", "Home", $page, ["class" => ""]);
}
...
for ($j = 1; $j < $pages; $j++) {
    ...
    if ($j >= $start && $j <= $end) {
        ...
        if ($j == ($page + 1)) {
            MVC\Helpers\Html::actionLink("selectedcategory", "<font size=\"5\" color=\"black\">" . $j . " </font>", "Home", $j, ["class" => ""]);
        } // Ссылки на остальные страницы
        else {
            MVC\Helpers\Html::actionLink("selectedcategory", " " . "<font size=\"5\">" . $j . " </font>" . " ", "Home", $j, ["class" => ""]);
        }
    }
}
...
if ($j > $page && ($page + 2) < $j) {
    ...
    MVC\Helpers\Html::actionLink("selectedcategory", "<font size=\"5\">></font>", "Home", $page + 2, ["class" => ""]);
    // Так как у нас $j = количество страниц + 1, то теперь 
    // уменьшаем его на единицу и получаем ссылку на последнюю страницу
    MVC\Helpers\Html::actionLink("selectedcategory", "<font size=\"5\"> >></font>", "Home", $j - 1, ["class" => ""]);
}
